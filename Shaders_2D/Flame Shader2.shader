Shader "FX/Fire Distort2"
{
    ...
    Properties
    {
        ...
        _OpacityFactor("OpacityFactor", Range(0,1)) = 0
...
#include "UnityCG.cginc"
    ...
    float _Height, _Edge, _Distort, _Hard, _OpacityFactor;
    v2f vert(appdata v)
    {
        v2f o;
    ...
    fixed4 frag(v2f i) : SV_Target
    {
        ...
        if(finalcolor.a != 0)
            finalcolor.a = saturate(i.uv3.y/_OpacityFactor);

        if(finalcolor.g < 0.2 && finalcolor.a == 1)
            finalcolor.a = finalcolor.g*1/0.2;
        return finalcolor;
