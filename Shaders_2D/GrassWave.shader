...
Shader"Transparent/Cutout/windy" {
 ...
 _ShakeDisplacement ("Shake Displacement" , Range( -5 ,5 ))= 0.5
 _ShakeTime ("Shake Time" , Range( 0 ,5 ))= 0.5
 _ShakeWindspeed ("Shake Windspeed" , Range( -2 ,2 ))= 0.5
 _ShakeBending ("Shake Bending" , Range( -2 ,2 ))= 0.5
 WindDirectionx ("WindX" , Range( -2 ,2 ))= 0.5
 WindDirectionz ("WindZ" , Range( -2 ,2 ))= 0.5
 }
