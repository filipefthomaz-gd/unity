Shader "Custom/Toon/Water"
{
    Properties
    {
        ...
        _WaveStrength("Wave Strength", Vector) = (0.4,0,0,0)
        _WaveSpeed("Wave Speed", Vector) = (100,0,0,0)
        _HeightMinFoam("Height Min Foam", Float) = 300	
    }
    SubShader
    {
		Tags
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                float displacementX = (cos(worldPos.y)+cos(worldPos.x+(_WaveSpeed.x*_Time)));
                float displacementZ = (cos(worldPos.y)+cos(worldPos.z+(_WaveSpeed.z*_Time)));

                worldPos.y = worldPos.y + (displacementX*_WaveStrength.x+displacementZ*_WaveStrength.z);
                o.height = worldPos.y;
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                if(i.height > _HeightMinFoam)
                    waterColor = float4(1,1,1,1);
